...
void visualize_nerf_bbox(ImDrawList* list, const Eigen::Matrix<float, 4, 4>& world2proj, const Eigen::Matrix<float, 8, 3>& bbox, uint32_t col = 0x80ffffff, float thickness = 2.f);
#endif
